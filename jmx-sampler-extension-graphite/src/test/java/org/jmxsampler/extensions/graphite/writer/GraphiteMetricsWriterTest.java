...
public class GraphiteMetricsWriterTest {
	...
	public void serializeValueWithPrefix() {
		final GraphiteMetricsWriter testee = new GraphiteMetricsWriter(new GraphiteWriterConfig("name", "host", 2811, "prefix_"));
	...
	public void serializeValueWithoutPrefix() {
		final GraphiteMetricsWriter testee = new GraphiteMetricsWriter(new GraphiteWriterConfig("name", "host", 2811, null));
		final long timestamp = System.currentTimeMillis();
